...
class Library:
    ...
    def __str__(self) -> str:
        return f"Biblioteka w miescie: {self.city}, przy ulicy {self.zip_code} otwarta w godzianch {self.open_hours}"

class Order:
    def __init__(self, employee: str, student: str, books: list, order_date: str) -> None:
    ...
    def __str__(self) -> str:
         return f"Zamowienie zamowione dnia: {self.order_date}, przez {self.student}, zrealizowane przez {self.employee}"
...
class Employee:
    ...
    def __str__(self) -> str:
        return f"Pracownik {self.first_name} {self.last_name} urodzony {self.birth_date} zatrudniony {self.hire_date}"

class Book:
    def __init__(self, library: str, publication_date: str, author_name: str, author_surname: str, number_of_pages: int) -> None:
    ...
    def __str__(self) -> str:
        return f"Ksiazka z biblioteki {self.library}. Autor ksiazki: {self.author_name} {self.author_surname}"
...
emp1 = Employee("Jan", "Nowak", "03.11.2018", "10.11.1990", "Katowice", "Dluga", "43-112", "123456789")
emp1 = Employee("Jan", "Kowalski", "03.09.2016", "10.11.1995", "Katowice", "Szeroka", "43-112", "987654321")
emp1 = Employee("Kamil", "Nowak", "03.12.2015", "10.11.1998", "Katowice", "Głęboka", "43-112", "654123890")
